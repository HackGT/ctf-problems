 <?php
    ...
    $salt = "buzzislife";
    $super_secure_hash = base64_encode($salt.$password);
    ...
    $sql = "SELECT * FROM users WHERE username = '".$username."' and password = '".$super_secure_hash."'";

    if($result = mysql_query($sql, $link)) {
	    if($row = mysql_fetch_row($result)){   
	        
      		die("Welcome, ".$row[0]."! I'm afraid you're too late... the flag's already faced the hatred of ten thousand years :(");
